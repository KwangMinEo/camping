...
<body>
	...
	<%
		String str = (String) session.getAttribute("naver");

		dto = sql.reserve_config(str);
		Rname = dto.getName();
		Rphone = dto.getPhone();
	%>
		...
		<form name="iform" method="post" enctype="multipart/form-data"
			...
			<table class="table1">
				<tr>
					...
					<td colspan="2"><input type="text" size="10" readonly
						name="sabun" value="<%=str%>"> <label id="sabunlabel"></label>
					</td>
					<td rowspan="3">
						<div>
			...
			<p>
				...
				<input type="reset" value="초기화">&nbsp;&nbsp; <input
					type="button" value="목록" onclick="location.href='campList.jsp'">
		</form>
	</div>
